...
uint32_t Wheel(uint8_t pos) {
  pos = pos * 3;
  if (pos < 85) return rgbLed.Color(pos * 3, 255 - pos * 3, 0);
  if (pos < 170) { pos -= 85; return rgbLed.Color(255, 0, pos * 3); }
  if (pos < 255) { pos -= 170; return rgbLed.Color(255 - pos * 3, 0, 255); }
  pos -= 255;
