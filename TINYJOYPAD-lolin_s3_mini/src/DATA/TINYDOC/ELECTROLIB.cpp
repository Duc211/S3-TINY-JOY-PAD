...
__attribute__((weak)) uint8_t SPEED_BLITZ(int8_t xPos, int8_t yPos, uint8_t xPASS, uint8_t yPASS, uint8_t FRAME, const uint8_t *SPRITES) {
...
__attribute__((weak)) uint8_t SplitSpriteDecalageY(uint8_t decalage, uint8_t Input, uint8_t UPorDOWN) {
  if (UPorDOWN) { return Input << decalage; }
  return Input >> (8 - decalage);
}

__attribute__((weak)) int8_t RecupeLineY(int8_t Valeur) {
  return (Valeur >> 3);
}

__attribute__((weak)) uint8_t RecupeDecalageY(uint8_t Valeur) {
  return (Valeur - ((Valeur >> 3) << 3));
}

__attribute__((weak)) uint8_t Mymap(uint8_t x, uint8_t in_min, uint8_t in_max, uint8_t out_min, uint8_t out_max) {
  return (x - in_min) * (out_max - out_min) / (in_max - in_min) + out_min;
}

__attribute__((weak)) uint8_t Trace_LINE(uint8_t DESACTIVE_, uint8_t x1, uint8_t y1, uint8_t x2, uint8_t y2, uint8_t xPASS, uint8_t yPASS) {
...
__attribute__((weak)) uint8_t DIRECTION_LINE(uint8_t DESACTIVE_, uint8_t x1, uint8_t y1, uint8_t x2, uint8_t y2, uint8_t xPASS, uint8_t yPASS) {
  uint8_t XL_ = 0;
  uint8_t YL_ = 0;
  uint8_t RESULTANT = 0;
  uint8_t Yref_ = 0;
...
__attribute__((weak)) uint8_t Return_Full_Byte(uint8_t x1, uint8_t y1, uint8_t x2, uint8_t y2, uint8_t xPASS, uint8_t yPASS) {
  uint8_t Byte_add_ = 0;
  uint8_t t = 0, tout = 0;
  uint8_t A_ = 0, B_ = 0;
  A_ = (yPASS << 3);
...
__attribute__((weak)) void Universal_Swap(uint8_t *A_, uint8_t *B_) {
  uint8_t T_ = *A_;
  *A_ = *B_;
  *B_ = T_;
}

__attribute__((weak)) uint8_t RECONSTRUCT_BYTE(uint8_t Min_, uint8_t Max_) {
  uint8_t A_ = (0xff << Min_);
  uint8_t B_ = 0xff - (0xff << Max_);
  return (A_ & B_);
}

__attribute__((weak)) void FADE(const uint8_t *PIC, uint8_t FADE) {
  uint8_t y, x, l, l2;
  for (l = 0; l < 9; l++) {
    _delay_ms(20);
...
__attribute__((weak)) void PLAY_MUSIC(const uint8_t *Music_) {
...
__attribute__((weak)) void Sound(uint8_t freq_,uint8_t dur){
